...
<f:view>
  <html>
    ...
    <body><h:form>
        ...
        <h:dataTable value="#{WineList.winesList}" var="wines"  binding="#{WineList.dataTable1}" id="dataTable1">
          <!--oracle-jdev-comment:Faces.RI.DT.Class.Key:com.apress.ejb3.wineapp.Wine-->
          <h:column>
            <f:facet name="header">
          ...
          <h:column>
            <h:commandButton value="Add to Cart"
                             action="#{WineList.invokeAddToCart}"/>
          </h:column>
        </h:dataTable>
      </h:form></body>
  </html>
