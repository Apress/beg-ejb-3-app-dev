package com.apress.ejb3.ch04.singletable.client;

import com.apress.ejb3.ch04.singletable.Address;
import com.apress.ejb3.ch04.singletable.Employee;
import com.apress.ejb3.ch04.singletable.FullTimeEmployee;
import com.apress.ejb3.ch04.singletable.PartTimeEmployee;
import com.apress.ejb3.ch04.singletable.Person;
...
/*
 * Sample entity client that obtains an EntityManager running outside of a
 * Java EE container, and illustrates CRUD operations on a handful of entities
 */
public class EntityClient
{
  private static final String PERSISTENCE_UNIT = "SingleTable-JSE";
