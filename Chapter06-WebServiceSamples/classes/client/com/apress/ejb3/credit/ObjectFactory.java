 ...
 * generated in the com.apress.ejb3.credit package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreditCheck_QNAME = new QName("http://www.apress.com/ejb3/credit", "CreditCheck");
    private final static QName _CreditCheckResponse_QNAME = new QName("http://www.apress.com/ejb3/credit", "CreditCheckResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.apress.ejb3.credit
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.apress.com/ejb3/credit", name = "CreditCheck")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.apress.com/ejb3/credit", name = "CreditCheckResponse")
